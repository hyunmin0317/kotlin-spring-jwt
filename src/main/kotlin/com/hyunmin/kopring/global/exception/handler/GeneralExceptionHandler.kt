...
class GeneralExceptionHandler {
    ...
    protected fun handleGeneralException(ex: GeneralException): ResponseEntity<ErrorResponse<Void>> {
    ...
    protected fun handleMethodArgumentNotValidException(ex: MethodArgumentNotValidException): ResponseEntity<ErrorResponse<Map<String, String>>> {
        log.warn("[WARNING] {} : {}", ex.javaClass, ex.message)
    ...
    protected fun handleDataIntegrityViolationException(ex: DataIntegrityViolationException): ResponseEntity<ErrorResponse<Void>> {
        log.warn("[WARNING] {} : {}", ex.javaClass, ex.message)
    ...
    protected fun handleHandlerMethodValidationException(ex: HandlerMethodValidationException): ResponseEntity<ErrorResponse<Void>> {
        log.warn("[WARNING] {} : {}", ex.javaClass, ex.message)
    ...
    protected fun handleHttpRequestMethodNotSupportedException(ex: HttpRequestMethodNotSupportedException): ResponseEntity<ErrorResponse<Void>> {
        log.warn("[WARNING] {} : {}", ex.javaClass, ex.message)
    ...
    protected fun handleException(ex: Exception): ResponseEntity<ErrorResponse<Void>> {
