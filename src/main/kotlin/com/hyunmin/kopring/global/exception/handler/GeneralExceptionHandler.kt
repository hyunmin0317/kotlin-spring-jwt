...
class GeneralExceptionHandler {
    ...
    fun handleMethodArgumentTypeMismatchException(ex: MethodArgumentTypeMismatchException): ResponseEntity<ErrorResponse<Void>> {
        log.warn("[WARNING] {} : {}", ex.javaClass, ex.message)
    ...
    private fun extractErrorCode(ex: HandlerMethodValidationException): ErrorCode =
        ex.valueResults
            ...
            .firstNotNullOfOrNull(MessageSourceResolvable::getDefaultMessage)
